...
class FirstOnboardingViewCell: UICollectionViewCell {
    ...
    let image = {
        ...
        view.image = UIImage( named: "onboarding_first")
    ...
    let title = {
        let view = UILabel()
        view.text = "Set tasks, monitor projects, control projects!"
    ...
    let descriptionTV = {
        let view = UILabel()
        view.text = "The application will help you develop your Projects and monitor statistics"
